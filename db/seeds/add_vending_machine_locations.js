  ...
  await knex('vending_machine_locations').insert([
    {
      ...
      z_coordinate: null,
      description: 'Vending machine located at the UCI Student Center with snacks and drinks.',
    },
    {
      id: 'loc_000002',
      ...
      z_coordinate: null,
      description: 'Vending machine near the Irvine Spectrum Center, offering cold beverages and chips.',
    },
    {
      id: 'loc_000003',
      ...
      z_coordinate: null,
      description: 'Beachside vending machine with sunscreen, snacks, and energy drinks.',
    },
  ]);
}
